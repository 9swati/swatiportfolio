...
const HeroSection = () => {
  ...
  return <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute bottom-20 right-10 w-32 h-32 bg-gradient-primary rounded-full blur-2xl animate-float opacity-15" style={{
      animationDelay: '1s'
    }}></div>
      <div className="absolute top-1/2 left-1/4 w-16 h-16 bg-secondary rounded-full blur-lg animate-float opacity-25" style={{
      animationDelay: '2s'
    }}></div>
      <div className="absolute top-1/3 right-1/3 w-12 h-12 bg-primary rounded-full blur-md animate-float opacity-20" style={{
      animationDelay: '1.5s'
    }}></div>
      
      {/* Tech stack floating icons */}
      <div className="absolute top-24 right-20 p-3 bg-background/10 backdrop-blur-lg rounded-lg border border-white/20 animate-float opacity-80" style={{
      animationDelay: '0.5s'
    }}>
        <Code className="h-6 w-6 text-primary" />
      </div>
      <div className="absolute bottom-32 left-20 p-3 bg-background/10 backdrop-blur-lg rounded-lg border border-white/20 animate-float opacity-80" style={{
      animationDelay: '2.5s'
    }}>
        <Database className="h-6 w-6 text-secondary" />
      </div>
      <div className="absolute top-1/2 right-20 p-3 bg-background/10 backdrop-blur-lg rounded-lg border border-white/20 animate-float opacity-80" style={{
      animationDelay: '1.8s'
    }}>
      ...
      <div className="container mx-auto px-4 pt-16 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left space-y-8">
            ...
            animationDelay: '0.2s'
              ...
              <h1 className="text-4xl md:text-7xl font-bold leading-tight">
                ...
                <span className="relative">
                  ...
                  {/* Animated underline */}
                  <div className="absolute -bottom-2 left-0 right-0 h-1 bg-gradient-primary rounded-full transform scale-x-0 animate-scale-in" style={{
                  animationDelay: '1s'
                }}></div>
                </span>
              </h1>
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-lg mx-auto lg:mx-0 leading-relaxed animate-slide-up" style={{
            animationDelay: '0.4s'
          }}>
              Passionate about building{" "}
              <span className="bg-gradient-primary bg-clip-text text-transparent font-semibold">scalable web and Full Stack applications</span>{" "}
            ...
            animationDelay: '0.6s'
              ...
              <Button variant="hero" size="lg" onClick={() => scrollToSection('projects')} className="group relative overflow-hidden">
            ...
            <div className="flex justify-center lg:justify-start gap-6 pt-8 animate-slide-up" style={{
            animationDelay: '0.8s'
          }}>
              {[{
              value: "3+",
              ...
              label: "Stack",
              icon: Globe
            }].map((stat, index) => <div key={index} className="group p-4 bg-background/10 backdrop-blur-lg rounded-xl border border-white/20 hover:bg-background/20 transition-all duration-300 hover:shadow-glow hover:-translate-y-1">
          ...
          animationDelay: '1s'
            ...
            <div className="relative group">
              ...
              <div className="relative w-80 h-80 md:w-96 md:h-96 rounded-full overflow-hidden border-4 border-white/20 backdrop-blur-sm shadow-glow group-hover:shadow-[0_0_60px_hsl(258_90%_66%_/_0.4)] transition-all duration-500">
                <img src={swatiPhoto} alt="Swati Mali - Full Stack Developer" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
              ...
              <div className="absolute top-1/4 -left-8 w-8 h-8 bg-primary/80 rounded-full animate-float opacity-80" style={{
              animationDelay: '1s'
            }}></div>
              <div className="absolute bottom-1/4 -right-8 w-6 h-6 bg-secondary/80 rounded-full animate-float opacity-80" style={{
              animationDelay: '2s'
            }}></div>
              
              {/* Tech stack indicators around image */}
              <div className="absolute top-8 left-8 px-3 py-1 bg-background/20 backdrop-blur-md rounded-full border border-white/30 text-xs font-medium text-primary animate-fade-in" style={{
              animationDelay: '1.5s'
            }}>
                React
              </div>
              <div className="absolute bottom-8 right-8 px-3 py-1 bg-background/20 backdrop-blur-md rounded-full border border-white/30 text-xs font-medium text-secondary animate-fade-in" style={{
              animationDelay: '2s'
            }}>
                Node.js
              </div>
